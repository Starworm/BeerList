...
export class HomeComponent extends DestroyUnsubscribe implements OnInit {
  ...
  @ViewChild('inp', {static: true}) beerName: ElementRef;
  ...
  ngOnInit(): void {
    ...
    fromEvent(this.beerName.nativeElement, 'keyup')
      .pipe(
  ...
  public getBeersFromPage(page: number): void {
    this.beerName.nativeElement.value = '';
    this.clickedBeer = -1;
